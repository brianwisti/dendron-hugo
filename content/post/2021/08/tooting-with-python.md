---
created: '2024-02-12 03:44:52'
date: 2021-08-15 07:00:00+00:00
description: Spent the day goofing off with Mastodon.py
fname: pub.post.2021.08.tooting-with-python
id: lcr2v2j63w89esnaxikxhcy
...
[Python]({{< relref "/card/python.md" >}}) is the [second best](https://twitter.com/glyph/status/1426414435275448324) tool for any job in 2021, which makes it an excellent glue language.  I've been centering my site workflow around it. That means the [Mastodon.py](https://mastodonpy.readthedocs.io/en/stable/) library, which I have dabbled with once or twice before.

### Why?

Because I've let the [Indieweb]({{< relref "/card/indieweb.md" >}}) social aspects of this site go stale and one step to fixing that is restoring POSSE automation. The first part of *that* is making sure I remember how to automate posting to Mastodon.

## Ok fine; get on with it

Course, you're going to need an account at a Mastodon instance.  I have my
account on [hackers.town](https://hackers.town/@randomgeek), one instance of many. You can find one suitable for your tastes at [Mastodon instances](https://instances.social).
...
> [!NOTE]
> Spoiler alert: yes I'll be using [Rich]({{< relref "/card/rich.md" >}}) and [dataclasses](https://docs.python.org/3/library/dataclasses.html) along with Mastodon.py.  Nothing fancy planned with Rich today. It's just part of my regular toolkit.
>
...
![toot screenshot](assets/img/2021/toot.jpg "It worked!")
