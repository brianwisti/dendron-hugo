...
updated: '2024-08-07 18:36:44'
---

## Introduction

We started looking at arrays in [Parrot Babysteps 04 Adding Command Line Arguments]({{< relref "/post/2009/09/parrot-babysteps-04-adding-command-line-arguments.md" >}}). We're going to take a closer look today, exploring different ways of looking at [Parrot]({{< relref "/card/parrot.md" >}}) arrays to build an averaging calculator. We'll start with no array at all, to build the basic flow of our program and to demonstrate that an array is not always needed. Then we'll move on to more interesting stuff, with array indexing, stack opcodes, and iterators.
