...
description: ''
fname: pub.post.2023.05.a-fun-python-turtle-youtube-playlist
id: 5ddw946cv6wxfmk7a87ky48
...
Got a little bored of trying to build relevant skills for my ongoing job search. Went through Coding Cassowary's [Generative Art playlist](https://www.youtube.com/playlist?list=PLBLV84VG7Md9oO4MUOhyqz7gBFOzx8XIw) yesterday instead. Had some ideas and fiddled a bit more with those ideas today. Trees should have leaves usually, right?

I'll share the code, but only if you promise to remember this is my brain adding unsorted thoughts to code from the aforementioned playlist. Most of the thoughts in here are unfinished. What I *want* is for you to watch the playlist. And have some fun drawing with [Python]({{< relref "/card/python.md" >}}), using [Turtle](https://docs.python.org/3/library/turtle.html) or some other library.
