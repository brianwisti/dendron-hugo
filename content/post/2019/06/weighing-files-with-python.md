...
Or maybe find the median between my biggest and smallest files, flagging everything bigger than the median. I promised [Python]({{< relref "/card/python.md" >}}) in the tags, so let’s move away from Perl.
