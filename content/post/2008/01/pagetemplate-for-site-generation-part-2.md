...
updated: '2024-08-07 18:33:26'
---

The [Ruby]({{< relref "/card/ruby/_index.md" >}}) code I wrote in [Pagetemplate for Site Generation]({{< relref "/post/2008/01/pagetemplate-for-site-generation.md" >}}) filtering Markdown. Now I want to stuff that filtered content into an HTML page. I could just use `maruku#to_html_document`, but I need the ability to add details like a title and site-related links.
